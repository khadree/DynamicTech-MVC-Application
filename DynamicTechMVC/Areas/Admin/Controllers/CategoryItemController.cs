...
using DynamicTechMVC.Extensions;
using Microsoft.AspNetCore.Authorization;

namespace DynamicTechMVC.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Index(int categoryId)
        {
            List<CategoryItem> list = await (from catItem in _context.CategoryItem 
                                             ...
                                             { 
                                                 ...
                                                 DateReleased = catItem.DateReleased, 
        ...
        public async Task<IActionResult> Create( int categoryId)
        {
            ...
            {
                CategoryId = categoryId,
                MediaType = mediaTypes.ConvertToSelectdList(0)
            };
            return View(categoryItem);
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CategoryId,MediaTypeId,DateReleased")] CategoryItem categoryItem)
        {
            ...
            List<MediaType> mediaTypes = await _context.MediaType.ToListAsync();
            categoryItem.MediaType = mediaTypes.ConvertToSelectdList(categoryItem.MediaTypeId);
            return View(categoryItem);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CategoryId,MediaTypeId,DateReleased")] CategoryItem categoryItem)
        {
